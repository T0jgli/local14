...
public class Report : Tdf
{
    ...
    private TdfMap<uint, Blaze3SDK.Blaze.GameReporting.Frostbite.GroupReport> _groupReports = new(__typeInfos[0]);
    private TdfMap<string, string> _gameAttributes = new(__typeInfos[1]);
    private TdfMap<long, Blaze3SDK.Blaze.GameReporting.Frostbite.EntityReport> _playerReports = new(__typeInfos[2]);
    ...
    public override string GetFullClassName() => "Blaze::GameReporting::Frostbite::Report";

    public IDictionary<uint, Blaze3SDK.Blaze.GameReporting.Frostbite.GroupReport> GroupReports
    {
